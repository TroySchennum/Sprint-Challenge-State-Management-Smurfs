...
reducers manage the state, actions update information, and store is the state memory. It's the single source of truth because it's where state is known for sure.

- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

application state is global but componenet state only relates to that component.

- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

It is middleware that lets you return a function instead of an action object.It allows them to be more complex.

- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!

Context API was very streamlined and easy to use.
